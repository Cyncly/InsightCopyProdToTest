...
GO
-- Version : $Id: A020_scDBA_utl Set Database Options.sql,v 1.58 2019/07/12 18:36:32 US01\moldvl Exp $  
BEGIN TRY
    ...
    (
        SELECT
            CONCAT
            (
                CASE WHEN [compatibility_level] != 140 THEN N', COMPATIBILITY_LEVEL = 140' + NCHAR(13) END
    ...
    (
        SELECT 
            STRING_AGG(
                CONCAT('ALTER QUEUE ', qn.QN, ' WITH STATUS = ON;')
                ,CHAR(13)
